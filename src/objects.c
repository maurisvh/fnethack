...
#define SCROLL(name,text,mgc,prob,cost) OBJECT( \
	...
	SCROLL("confuse monster",       "NR 9",                 1,  55, 100),
	SCROLL("scare monster",         "XIXAXA XOXAXA XUXAXA", 1,  37, 100),
	SCROLL("remove curse",          "PRATYAVAYAH",          1,  67,  80),
	SCROLL("enchant weapon",        "DAIYEN FOOELS",        1,  82,  60),
	SCROLL("create monster",        "LEP GEX VEN ZEA",      1,  47, 200),
	SCROLL("taming",                "PRIRUTSENIE",          1,  17, 200),
	SCROLL("genocide",              "ELBIB YLOH",           1,  17, 300),
	SCROLL("light",                 "VERR YED HORRE",       1,  92,  50),
	SCROLL("teleportation",         "VENZAR BORGAVVE",      1,  57, 100),
	SCROLL("gold detection",        "THARR",                1,  35, 100),
	SCROLL("food detection",        "YUM YUM",              1,  27, 100),
	SCROLL("identify",              "KERNOD WEL",           1, 182,  20),
	SCROLL("magic mapping",         "ELAM EBOW",            1,  46, 100),
	SCROLL("fire",                  "ANDOVA BEGARIN",       1,  31, 100),
	SCROLL("earth",                 "KIRJE",                1,  19, 200),
	SCROLL("punishment",            "VE FORBRYDERNE",       1,  16, 300),
	SCROLL("charging",              "HACKEM MUCHE",         1,  16, 300),
	SCROLL("stinking cloud",	"VELOX NEB",            1,  16, 300),
