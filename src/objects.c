...
CONTAINER("sack", "bag",                0, 0, 0,  35, 15,  20, CLOTH, HI_CLOTH),
CONTAINER("oilskin sack", "bag",        0, 0, 0,   5, 15,  20, CLOTH, HI_CLOTH),
CONTAINER("bag of holding", "bag",      0, 1, 0,  20, 15,  20, CLOTH, HI_CLOTH),
CONTAINER("bag of tricks", "bag",       0, 1, 1,  20, 15,  20, CLOTH, HI_CLOTH),
#undef CONTAINER

/* lock opening tools */
TOOL("key", (char *)0,          0, 0, 0, 0,  80,  3,  10, IRON, HI_METAL),
#ifdef TOURIST
...
TOOL("oil lamp", "lamp",        0, 0, 0, 0,  45, 20,  25, COPPER, CLR_YELLOW),
TOOL("magic lamp", "lamp",      0, 0, 1, 0,  15, 20,  25, COPPER, CLR_YELLOW),
/* other tools */
#ifdef TOURIST
...
POTION("gain ability", "ruby",          1, 0,          65, CLR_RED),
POTION("restore ability", "pink",       1, 0,          63, CLR_BRIGHT_MAGENTA),
POTION("confusion", "orange",           1, CONFUSION,  65, CLR_ORANGE),
POTION("blindness", "yellow",           1, BLINDED,    63, CLR_YELLOW),
POTION("paralysis", "emerald",          1, 0,          65, CLR_BRIGHT_GREEN),
POTION("speed", "dark green",           1, FAST,       64, CLR_GREEN),
POTION("levitation", "cyan",            1, LEVITATION, 64, CLR_CYAN),
POTION("invisibility", "brilliant blue",1, INVIS,      63, CLR_BRIGHT_BLUE),
POTION("healing", "purple-red",         1, 0,          70, CLR_MAGENTA),
POTION("gain level", "milky",           1, 0,          33, CLR_WHITE),
POTION("enlightenment", "swirly",       1, 0,          32, CLR_BROWN),
POTION("monster detection", "bubbly",   1, 0,          62, CLR_WHITE),
POTION("object detection", "smoky",     1, 0,          64, CLR_GRAY),
POTION("gain energy", "cloudy",         1, 0,          64, CLR_WHITE),
POTION("polymorph", "golden",           1, 0,          12, CLR_YELLOW),
POTION("oil", "murky",                  0, 0,          37, CLR_BROWN),
POTION("water", "clear",                0, 0,         114, CLR_CYAN),
#undef POTION
...
#define SCROLL(name,text,mgc,prob,cost) OBJECT( \
	...
	SCROLL("enchant armor",         "ZELGO MER",            1,  73, 100),
	SCROLL("confuse monster",       "NR 9",                 1,  63, 100),
	SCROLL("scare monster",         "XIXAXA XOXAXA XUXAXA", 1,  46, 100),
	SCROLL("remove curse",          "PRATYAVAYAH",          1,  75, 100),
	SCROLL("enchant weapon",        "DAIYEN FOOELS",        1,  91, 100),
	SCROLL("create monster",        "LEP GEX VEN ZEA",      1,  56, 100),
	SCROLL("taming",                "PRIRUTSENIE",          1,  24, 100),
	SCROLL("light",                 "VERR YED HORRE",       1,  97, 100),
	SCROLL("teleportation",         "VENZAR BORGAVVE",      1,  66, 100),
	SCROLL("identify",              "KERNOD WEL",           1, 194, 100),
	SCROLL("magic mapping",         "ELAM EBOW",            1,  56, 100),
	SCROLL("fire",                  "ANDOVA BEGARIN",       1,  38, 100),
	SCROLL("earth",                 "KIRJE",                1,  26, 100),
	SCROLL("noise",                 "VE FORBRYDERNE",       1,  22, 100),
	SCROLL("charging",              "HACKEM MUCHE",         1,  22, 100),
	SCROLL("stinking cloud",	"VELOX NEB",            1,  22, 100),
...
SPELL("dig",             "parchment",   P_MATTER_SPELL, 27,  6, 5, 1, RAY,       HI_PAPER),
SPELL("magic missile",   "vellum",      P_ATTACK_SPELL, 52,  2, 2, 1, RAY,       HI_PAPER),
SPELL("fireball",        "ragged",      P_ATTACK_SPELL, 27,  4, 4, 1, RAY,       HI_PAPER),
SPELL("cone of cold",    "dog eared",   P_ATTACK_SPELL, 17,  7, 4, 1, RAY,       HI_PAPER),
SPELL("sleep",           "mottled",     P_ENCHANTMENT_SPELL, 57,  1, 1, 1, RAY,       HI_PAPER),
SPELL("light",           "cloth",       P_DIVINATION_SPELL, 52,  1, 1, 1, NODIR,     HI_CLOTH),
SPELL("detect monsters", "leather",     P_DIVINATION_SPELL, 50,  1, 1, 1, NODIR,     HI_LEATHER),
SPELL("healing",         "white",       P_HEALING_SPELL, 47,  2, 1, 1, IMMEDIATE, CLR_WHITE),
SPELL("force bolt",      "red",         P_ATTACK_SPELL, 42,  2, 1, 1, IMMEDIATE, CLR_RED),
SPELL("drain life",      "velvet",      P_ATTACK_SPELL, 17,  2, 2, 1, IMMEDIATE, CLR_MAGENTA),
SPELL("slow monster",    "light green", P_ENCHANTMENT_SPELL, 37,  2, 2, 1, IMMEDIATE, CLR_BRIGHT_GREEN),
SPELL("create monster",  "turquoise",   P_CLERIC_SPELL, 42,  3, 2, 1, NODIR,     CLR_BRIGHT_CYAN),
SPELL("cause fear",      "light blue",  P_ENCHANTMENT_SPELL, 32,  3, 3, 1, NODIR,     CLR_BRIGHT_BLUE),
SPELL("clairvoyance",    "dark blue",   P_DIVINATION_SPELL, 22,  3, 3, 1, NODIR,     CLR_BLUE),
SPELL("cure sickness",   "indigo",      P_HEALING_SPELL, 39,  3, 3, 1, NODIR,     CLR_BLUE),
SPELL("haste self",      "purple",      P_ESCAPE_SPELL, 40,  4, 3, 1, NODIR,     CLR_MAGENTA),
SPELL("detect unseen",   "violet",      P_DIVINATION_SPELL, 27,  4, 3, 1, NODIR,     CLR_MAGENTA),
SPELL("levitation",      "tan",         P_ESCAPE_SPELL, 27,  4, 4, 1, NODIR,     CLR_BROWN),
SPELL("extra healing",   "plaid",       P_HEALING_SPELL, 34,  5, 3, 1, IMMEDIATE, CLR_GREEN),
SPELL("restore ability", "light brown", P_HEALING_SPELL, 32,  5, 4, 1, NODIR,     CLR_BROWN),
SPELL("invisibility",    "dark brown",  P_ESCAPE_SPELL, 33,  5, 4, 1, NODIR,     CLR_BROWN),
SPELL("detect treasure", "gray",        P_DIVINATION_SPELL, 28,  5, 4, 1, NODIR,     CLR_GRAY),
SPELL("remove curse",    "wrinkled",    P_CLERIC_SPELL, 33,  5, 3, 1, NODIR,     HI_PAPER),
SPELL("magic mapping",   "dusty",       P_DIVINATION_SPELL, 26,  7, 5, 1, NODIR,     HI_PAPER),
SPELL("identify",        "bronze",      P_DIVINATION_SPELL, 28,  6, 3, 1, NODIR,     HI_COPPER),
SPELL("polymorph",       "silver",      P_MATTER_SPELL, 18,  8, 6, 1, IMMEDIATE, HI_SILVER),
SPELL("teleport away",   "gold",        P_ESCAPE_SPELL, 22,  6, 6, 1, IMMEDIATE, HI_GOLD),
SPELL("cancellation",    "shining",     P_MATTER_SPELL, 22,  8, 7, 1, IMMEDIATE, CLR_WHITE),
SPELL("protection",	     "dull",        P_CLERIC_SPELL, 25,  3, 1, 1, NODIR,     HI_PAPER),
SPELL("stone to flesh",	 "thick",       P_HEALING_SPELL, 22,  1, 3, 1, IMMEDIATE, HI_PAPER),
/* blank spellbook must come last because it retains its description */
SPELL("blank paper",     "plain",       P_NONE, 23,  0, 0, 0, 0,         HI_PAPER),
...
WAND("trap detection", "balsa",    50, 160, 1, NODIR,	  WOOD,     HI_WOOD),
WAND("enlightenment",  "crystal",  40, 150, 1, NODIR,     GLASS,    HI_GLASS),
WAND("create monster", "maple",    60, 200, 1, NODIR,     WOOD,     HI_WOOD),
WAND("wishing",        "pine",      5, 500, 1, NODIR,     WOOD,     HI_WOOD),
WAND("striking",       "ebony",    90, 150, 1, IMMEDIATE, WOOD,     HI_WOOD),
WAND("make invisible", "marble",   54, 150, 1, IMMEDIATE, MINERAL,  HI_MINERAL),
WAND("slow monster",   "tin",      65, 150, 1, IMMEDIATE, METAL,    HI_METAL),
WAND("polymorph",      "silver",   54, 200, 1, IMMEDIATE, SILVER,   HI_SILVER),
WAND("cancellation",   "platinum", 54, 200, 1, IMMEDIATE, PLATINUM, CLR_WHITE),
WAND("teleportation",  "iridium",  54, 200, 1, IMMEDIATE, METAL,    CLR_BRIGHT_CYAN),
WAND("probing",        "uranium",  49, 150, 1, IMMEDIATE, METAL,    HI_METAL),
WAND("digging",        "iron",     69, 150, 1, RAY,       IRON,     HI_METAL),
WAND("magic missile",  "steel",    69, 150, 1, RAY,       IRON,     HI_METAL),
WAND("fire",           "hexagonal",59, 175, 1, RAY,       IRON,     HI_METAL),
WAND("cold",           "short",    43, 175, 1, RAY,       IRON,     HI_METAL),
WAND("sleep",          "runed",    45, 175, 1, RAY,       IRON,     HI_METAL),
WAND("lightning",      "curved",   45, 175, 1, RAY,       IRON,     HI_METAL),
...
GEM("worthless piece of blue glass", "blue",     78, 1, 0, 6, 5, GLASS, CLR_BLUE),
GEM("worthless piece of red glass", "red",       78, 1, 0, 6, 5, GLASS, CLR_RED),
GEM("worthless piece of yellowish brown glass", "yellowish brown",
						 78, 1, 0, 6, 5, GLASS, CLR_BROWN),
GEM("worthless piece of orange glass", "orange", 78, 1, 0, 6, 5, GLASS, CLR_ORANGE),
GEM("worthless piece of yellow glass", "yellow", 78, 1, 0, 6, 5, GLASS, CLR_YELLOW),
GEM("worthless piece of black glass",  "black",  78, 1, 0, 6, 5, GLASS, CLR_BLACK),
GEM("worthless piece of green glass", "green",   78, 1, 0, 6, 5, GLASS, CLR_GREEN),
GEM("worthless piece of violet glass", "violet", 78, 1, 0, 6, 5, GLASS, CLR_MAGENTA),
