...
#define SCROLL(name,text,mgc,prob,cost) OBJECT( \
	...
	SCROLL("enchant armor",         "ZELGO MER",            1,  68, 100),
	SCROLL("confuse monster",       "NR 9",                 1,  59, 100),
	SCROLL("scare monster",         "XIXAXA XOXAXA XUXAXA", 1,  41, 100),
	SCROLL("remove curse",          "PRATYAVAYAH",          1,  71, 100),
	SCROLL("enchant weapon",        "DAIYEN FOOELS",        1,  86, 100),
	SCROLL("create monster",        "LEP GEX VEN ZEA",      1,  51, 100),
	SCROLL("taming",                "PRIRUTSENIE",          1,  20, 100),
	SCROLL("light",                 "VERR YED HORRE",       1,  97, 100),
	SCROLL("teleportation",         "VENZAR BORGAVVE",      1,  61, 100),
	SCROLL("gold detection",        "THARR",                1,  39, 100),
	SCROLL("food detection",        "YUM YUM",              1,  31, 100),
	SCROLL("identify",              "KERNOD WEL",           1, 188, 100),
	SCROLL("magic mapping",         "ELAM EBOW",            1,  50, 100),
	SCROLL("fire",                  "ANDOVA BEGARIN",       1,  34, 100),
	SCROLL("earth",                 "KIRJE",                1,  21, 100),
	SCROLL("noise",                 "VE FORBRYDERNE",       1,  18, 100),
	SCROLL("charging",              "HACKEM MUCHE",         1,  18, 100),
	SCROLL("stinking cloud",	"VELOX NEB",            1,  18, 100),
...
SPELL("dig",             "parchment",   P_MATTER_SPELL, 26,  6, 5, 1, RAY,       HI_PAPER),
SPELL("magic missile",   "vellum",      P_ATTACK_SPELL, 51,  2, 2, 1, RAY,       HI_PAPER),
SPELL("fireball",        "ragged",      P_ATTACK_SPELL, 26,  4, 4, 1, RAY,       HI_PAPER),
SPELL("cone of cold",    "dog eared",   P_ATTACK_SPELL, 16,  7, 4, 1, RAY,       HI_PAPER),
SPELL("sleep",           "mottled",     P_ENCHANTMENT_SPELL, 56,  1, 1, 1, RAY,       HI_PAPER),
SPELL("light",           "cloth",       P_DIVINATION_SPELL, 51,  1, 1, 1, NODIR,     HI_CLOTH),
SPELL("detect monsters", "leather",     P_DIVINATION_SPELL, 49,  1, 1, 1, NODIR,     HI_LEATHER),
SPELL("healing",         "white",       P_HEALING_SPELL, 46,  2, 1, 1, IMMEDIATE, CLR_WHITE),
SPELL("force bolt",      "red",         P_ATTACK_SPELL, 41,  2, 1, 1, IMMEDIATE, CLR_RED),
SPELL("drain life",      "velvet",      P_ATTACK_SPELL, 16,  2, 2, 1, IMMEDIATE, CLR_MAGENTA),
SPELL("slow monster",    "light green", P_ENCHANTMENT_SPELL, 36,  2, 2, 1, IMMEDIATE, CLR_BRIGHT_GREEN),
SPELL("create monster",  "turquoise",   P_CLERIC_SPELL, 41,  3, 2, 1, NODIR,     CLR_BRIGHT_CYAN),
SPELL("detect food",     "cyan",        P_DIVINATION_SPELL, 36,  3, 2, 1, NODIR,     CLR_CYAN),
SPELL("cause fear",      "light blue",  P_ENCHANTMENT_SPELL, 31,  3, 3, 1, NODIR,     CLR_BRIGHT_BLUE),
SPELL("clairvoyance",    "dark blue",   P_DIVINATION_SPELL, 21,  3, 3, 1, NODIR,     CLR_BLUE),
SPELL("cure sickness",   "indigo",      P_HEALING_SPELL, 38,  3, 3, 1, NODIR,     CLR_BLUE),
SPELL("haste self",      "purple",      P_ESCAPE_SPELL, 39,  4, 3, 1, NODIR,     CLR_MAGENTA),
SPELL("detect unseen",   "violet",      P_DIVINATION_SPELL, 26,  4, 3, 1, NODIR,     CLR_MAGENTA),
SPELL("levitation",      "tan",         P_ESCAPE_SPELL, 26,  4, 4, 1, NODIR,     CLR_BROWN),
SPELL("extra healing",   "plaid",       P_HEALING_SPELL, 33,  5, 3, 1, IMMEDIATE, CLR_GREEN),
SPELL("restore ability", "light brown", P_HEALING_SPELL, 31,  5, 4, 1, NODIR,     CLR_BROWN),
SPELL("invisibility",    "dark brown",  P_ESCAPE_SPELL, 31,  5, 4, 1, NODIR,     CLR_BROWN),
SPELL("detect treasure", "gray",        P_DIVINATION_SPELL, 26,  5, 4, 1, NODIR,     CLR_GRAY),
SPELL("remove curse",    "wrinkled",    P_CLERIC_SPELL, 31,  5, 3, 1, NODIR,     HI_PAPER),
SPELL("magic mapping",   "dusty",       P_DIVINATION_SPELL, 24,  7, 5, 1, NODIR,     HI_PAPER),
SPELL("identify",        "bronze",      P_DIVINATION_SPELL, 26,  6, 3, 1, NODIR,     HI_COPPER),
SPELL("polymorph",       "silver",      P_MATTER_SPELL, 16,  8, 6, 1, IMMEDIATE, HI_SILVER),
SPELL("teleport away",   "gold",        P_ESCAPE_SPELL, 21,  6, 6, 1, IMMEDIATE, HI_GOLD),
SPELL("cancellation",    "shining",     P_MATTER_SPELL, 21,  8, 7, 1, IMMEDIATE, CLR_WHITE),
SPELL("protection",	     "dull",        P_CLERIC_SPELL, 24,  3, 1, 1, NODIR,     HI_PAPER),
SPELL("stone to flesh",	 "thick",       P_HEALING_SPELL, 21,  1, 3, 1, IMMEDIATE, HI_PAPER),
...
WAND("enlightenment",  "crystal",  20, 150, 1, NODIR,     GLASS,    HI_GLASS),
