 ...
 */
    MON("giant ant", S_ANT,
	LVL(2, 14, 3, 0, 0), (G_GENO|G_SGROUP|3),
	...
	LVL(1, 14, -1, 0, 0), (G_GENO|G_LGROUP|2),
	...
	LVL(3, 14, 3, 0, 0), (G_GENO|G_SGROUP|2),
    ...
    MON("fire ant", S_ANT,
	LVL(3, 14, 3, 10, 0), (G_GENO|G_SGROUP|1),
 ...
 */
	...
	A(ATTK(AT_BITE, AD_PHYS, 4, 6), ATTK(AT_BREA, AD_FIRE, 4, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_BITE, AD_PHYS, 6, 6), ATTK(AT_BREA, AD_FIRE, 6, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(2, 1, 9, 10, 0), (G_GENO|G_NOGEN|5),
	...
	A(ATTK(AT_GAZE, AD_SLOW, 0, 0), ATTK(AT_GAZE, AD_SLEE, 2,25),
	  ATTK(AT_GAZE, AD_SLOW, 0, 0), ATTK(AT_GAZE, AD_STON, 0, 0),
 ...
 */
	...
	LVL(3, 7, 10, 0, -5), (G_GENO|G_LGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(2, 11, 7, 0, 0), (G_GENO|G_SGROUP|4),
 ...
 */
	...
	LVL(0, 13, 7, 0, 0), (G_GENO|G_SGROUP|1),
	...
	LVL(1, 11, 7, 0, 0), (G_GENO|G_SGROUP|2),
	A(ATTK(AT_BITE, AD_PHYS, 1, 3),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(1, 13, 3, 0, 0), (G_GENO|G_SGROUP|2),
	A(ATTK(AT_BITE, AD_PHYS, 1, 2),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(3, 3, 0, 0, 0), (G_GENO|G_NOCORPSE|2),
	...
	A(ATTK(AT_ENGL, AD_FIRE, 3,10), ATTK(AT_NONE, AD_FIRE, 0, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(0, 0, 0, MS_SILENT, MZ_HUGE),
	MR_FIRE|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_BREATHLESS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_MINDLESS|
 ...
 */
    MON("gnome", S_GNOME,
	LVL(1, 8, 10, 4, 0), (G_GENO|G_SGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	A(ATTK(AT_CLAW, AD_PHYS, 2,10), ATTK(AT_CLAW, AD_PHYS, 2,10),
 ...
 */
	...
	LVL(1, 12, 10, 10, 9), (G_GENO|G_LGROUP|G_NOGEN),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(3, 12, 10, 20, 11), (G_GENO|G_NOGEN),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 200, 0, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
	M2_HUMAN|M2_WANDER|M2_HOSTILE|M2_STRONG|M2_MALE|M2_COLLECT,
 ...
 */
	...
	A(ATTK(AT_TUCH, AD_COLD, 6, 6), ATTK(AT_MAGC, AD_SPEL, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1200, 100, 0, MS_MUMBLE, MZ_HUMAN),
 ...
 */
	...
	A(ATTK(AT_TUCH, AD_SLIM, 3, 4), ATTK(AT_NONE, AD_SLIM, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	A(ATTK(AT_CLAW, AD_ENCH, 5, 4), ATTK(AT_NONE, AD_ENCH, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(1, 10, 8, 0, 0), (G_LGROUP|G_GENO|1),
	A(ATTK(AT_BITE, AD_PHYS, 1, 2),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
	  ATTK(AT_BITE, AD_PHYS, 4, 3), ATTK(AT_STNG, AD_PHYS, 2, 3),
	  NO_ATTK, NO_ATTK),
...
#undef SEDUCTION_ATTACKS
	...
	A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
	  ATTK(AT_STNG, AD_PHYS, 5, 4), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_HUMAN), MR_FIRE|MR_POISON, 0,
	...
	A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
	  ...
	  ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK),
	...
	A(ATTK(AT_CLAW, AD_PHYS, 2, 3), ATTK(AT_CLAW, AD_PHYS, 2, 3),
	  ATTK(AT_BITE, AD_PHYS, 6, 4), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_FIRE|MR_POISON, 0,
	...
	A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_STNG, AD_DRST, 4, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_FIRE|MR_POISON, 0,
	...
	A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
	  ATTK(AT_BITE, AD_PHYS, 4, 4), ATTK(AT_STNG, AD_COLD, 4, 4),
	  NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
	  ATTK(AT_BITE, AD_PHYS, 4, 4), ATTK(AT_MAGC, AD_SPEL, 0, 0),
	  NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 6, 2), ATTK(AT_WEAP, AD_PHYS, 6, 2),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 8, 4), ATTK(AT_WEAP, AD_PHYS, 6, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_FIRE|MR_POISON, 0,
	...
	A(ATTK(AT_ENGL, AD_DISE, 6,10), ATTK(AT_SPIT, AD_ACID, 6, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 6, 6), ATTK(AT_WEAP, AD_CONF, 3, 8),
	  ATTK(AT_CLAW, AD_PLYS, 1, 6), ATTK(AT_MAGC, AD_MAGM, 3, 6),
	  NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 6, 6), ATTK(AT_CLAW, AD_PHYS, 6, 4),
	  ATTK(AT_CLAW, AD_PHYS, 6, 4), ATTK(AT_MAGC, AD_SPEL, 8, 6),
	...
	A(ATTK(AT_CLAW, AD_PHYS, 6, 6), ATTK(AT_CLAW, AD_PHYS, 6, 6),
	  ATTK(AT_STNG, AD_DRST, 4, 4), NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 6, 6), ATTK(AT_MAGC, AD_SPEL, 8, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_BITE, AD_DRST, 4, 6), ATTK(AT_GAZE, AD_STUN, 4, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_CLAW, AD_PHYS, 6, 4), ATTK(AT_MAGC, AD_COLD, 6, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(8, 14, -1, 0, -9), (G_HELL|1),
	A(ATTK(AT_WEAP, AD_PHYS, 4, 8), ATTK(AT_TUCH, AD_FIRE, 2, 6),
	  ATTK(AT_HUGS, AD_PHYS, 4, 6), ATTK(AT_HUGS, AD_FIRE, 6, 6),
	  NO_ATTK, NO_ATTK),
