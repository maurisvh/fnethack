...
E struct dgn_topology {		/* special dungeon levels for speed */
    ...
    d_level	d_trove1_level;
    d_level	d_trove2_level;
...
#define trove1_level		(dungeon_topology.d_trove1_level)
#define trove2_level		(dungeon_topology.d_trove2_level)
...
struct u_achieve {
        ...
        Bitfield(get_luckstone,1);   /* You obtained the luckstone at the
                                      * end of the mines. */
        Bitfield(unused_achieve,1);  /* This space intentionally left blank. */
